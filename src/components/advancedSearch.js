...
class AdvancedSearch extends Component {
  ...
  handleSubmit(event) {
    ...
    this.props.fetchAdvancedSearchResults({ dateMin, dateMax }, genres, lang, {
      runtimeMin,
      runtimeMax,
    })
  }
  ...
  render() {
    const langOptions = [{ label: 'english', value: 'en' }, { label: 'russian', value: 'ru' }]
    const genreOptions = genreList.map(item => ({ label: item, value: genreIds[item] }))
              ...
              <fieldset className="adv-search__min-max-fieldset">
                <label className="adv-search__label" htmlFor="inputDateMin">
                  ...
                  <input
                    ...
                    ref={input => {
                      this.inputDateMin = input
                    }}
                  />
                </label>
                <label className="adv-search__label" htmlFor="inputDateMax">
              ...
              <fieldset className="adv-search__min-max-fieldset">
                <label className="adv-search__label" htmlFor="inputRuntimeMin">
                  ...
                  <input
                    ...
                    className="adv-search__input input"
                    ref={input => {
                      this.inputRuntimeMin = input
                    }}
                  />
                </label>
                <label className="adv-search__label" htmlFor="inputRuntimeMax">
                   {/* eslint-disable-line no-trailing-spaces */}
                  <input
                    id="inputRuntimeMax"
                    type="text"
